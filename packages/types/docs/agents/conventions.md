# @hexadrop/types conventions

## Imports

Import with the package specifier `@hexadrop/types`; cross-workspace imports resolve through the root `tsconfig.json` paths to `../../src/`.
