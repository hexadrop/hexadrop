# @hexadrop/error conventions

## Imports

Import with the package specifier `@hexadrop/error`; cross-workspace imports resolve through the root `tsconfig.json` paths to `../../src/`.
