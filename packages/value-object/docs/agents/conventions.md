# @hexadrop/value-object conventions

## Imports

Import with the package specifier `@hexadrop/value-object`; cross-workspace imports resolve through the root `tsconfig.json` paths to `../../src/`.
