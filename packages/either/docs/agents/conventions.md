# @hexadrop/either conventions

## Imports

Import with the package specifier `@hexadrop/either`; cross-workspace imports resolve through the root `tsconfig.json` paths to `../../src/`.
